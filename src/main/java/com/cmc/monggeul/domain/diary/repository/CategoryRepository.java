...
public interface CategoryRepository extends JpaRepository<Category,String> {
    ...
    @Query(value = "select * from Category as c where (c.code like 'DAU_MOM') or (c.code like 'YOUNG')" +
            "or (c.code like 'REMEMBER') or (c.code like 'THINK')",nativeQuery = true)
    List<Category> findMomDauCategory();

    @Query(value = "select * from Category as c where (c.code like 'SON_DAD') or (c.code like 'YOUNG')" +
            "or (c.code like 'REMEMBER') or (c.code like 'THINK')",nativeQuery = true)
    List<Category> findDadSonCategory();

    @Query(value = "select * from Category as c where (c.code like 'DAU_DAD') or (c.code like 'YOUNG')" +
            "or (c.code like 'REMEMBER') or (c.code like 'THINK')",nativeQuery = true)
    List<Category> findDadDauCategory();

    @Query(value = "select * from Category as c where (c.code like 'MOM_DAU') or (c.code like 'YOUNG')" +
            "or (c.code like 'REMEMBER') or (c.code like 'THINK')",nativeQuery = true)
    List<Category> findDauMomCategory();

    @Query(value = "select * from Category as c where (c.code like 'DAD_DAU') or (c.code like 'YOUNG')" +
            "or (c.code like 'REMEMBER') or (c.code like 'THINK')",nativeQuery = true)
    ...
    @Query(value = "select * from Category as c where (c.code like 'DAD_SON') or (c.code like 'YOUNG')" +
            "or (c.code like 'REMEMBER') or (c.code like 'THINK')",nativeQuery = true)
